def question(x):
    if(x == "hi"):
        ...
        x ="i am good"
        e = "calm"
    elif(x =="who is the author of of mmice and men"):
        x ="John Steinback"
        e = None
    elif(x =="boo"):
        x ="ahhhh!"
        ...
        x = ("what where?")
        e = None
    elif(x =="there is a bird over there"):
        x = ("uhhhh what?")
        e = None
    elif(x =="hey im tess"):
        x = ("oh hi ive heard about you")
        e = None
    elif(x =="what have you heard about me"):
        x = ("I heard your weird")
        e = None
    elif(x =="you're weird"):
        x = ("uhh thx?")
        e = None
      ...
      import talker
      talker.rewrite(x,"interphaze.py")
      return('','F')
    return(x,e)